...
\subsection{Desvío de la luz\times  }
...
Luego, el \textbf{ángulo total de desvío} corresponde a la integral sobre todos los diferenciales de ángulo $\theta$
\begin{equation}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.55]{desvluz1.jpg}
